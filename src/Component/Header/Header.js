            ...
            <Navbar.Collapse id="basic-navbar-nav">
               <Nav className="ms-auto header-bg">
                  <Link
                     ...
                     } text-decoration-none fs-4 me-3 my-auto`}
                     to="/blogs"
                  >
                     Blogs
                  </Link>
                  <Link
                     className={`${
                        navbar ? "link-color" : "text-color"
                     } text-decoration-none text-color fs-4 me-3 my-auto`}
                     to="/aboutUs"
                  >
                     About Us
                  </Link>
                  {user ? (
                     <>
                        ...
                        <button onClick={handleSignOut} className="update-btn">
                           Log Out
                        </button>
                     </>
                  ) : (
